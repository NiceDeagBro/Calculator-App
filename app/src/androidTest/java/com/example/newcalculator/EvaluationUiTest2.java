...
public class EvaluationUiTest2 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void evaluationUiTest2() {
        ...
        ViewInteraction materialButton7 = onView(
                allOf(withId(R.id.plus_minus_btn), withText("+/-"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tableLayout),
                                        0),
        ...
        ViewInteraction materialButton11 = onView(
                allOf(withId(R.id.divide__btn), withText("?"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.tableLayout),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvResult), withText("1"),
